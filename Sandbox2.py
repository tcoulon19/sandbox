...
class ExerciseSession:
    ...
    def __init__(self, excercise_name, exercise_intensity, exercise_duration):
        self.exercise_name = excercise_name
    ...
    def set_duration(self, exercise_duration):
        self.exercise_duration = exercise_duration
...
# # Example converting JSON to Python object, then back to JSON
# import json
